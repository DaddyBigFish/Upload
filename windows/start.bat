...
function printHelp(){
	...
	WScript.Echo("wait       - to wait or not for command to finish.Default is no");
	...
	WScript.Echo("");
    WScript.Echo("0 - [Default] Hides the window and activates another window.");
    WScript.Echo("1 - Activates and displays a window. If the window is minimized or maximized, the system restores it to its original size and position.\r\n     An application should specify this flag when displaying the window for the first time.");
